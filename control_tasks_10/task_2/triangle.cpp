...
Triangle::Triangle()
{
	...
	cout << "First point: "; cin >> x_1; cin >> y_1;
	cout << "Second point: "; cin >> x_2; cin >> y_2;
	cout << "Third point: "; cin >> x_3; cin >> y_3;

	Dot dot_1 = Dot(x_1, y_1);
	Dot dot_2 = Dot(x_2, y_2);
	Dot dot_3 = Dot(x_3, y_3);

	Triangle::set_dot_1(dot_1);
	Triangle::set_dot_2(dot_2);
	Triangle::set_dot_3(dot_3);
}
